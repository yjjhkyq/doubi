...
public class McHelper {
    ...
    public static SendMessageAO buildProductGreenNotify(Long targetId, String productTitle, Date videoCreateDate, boolean greenPass){
        ...
        return new SendMessageAO(SenderSystemType.SECRETARY.getValue(), 0L, targetId, MessageType.GENERAL_MSG.name(), greenResult,
    ...
    public static SendMessageAO buildFansNotify(Long targetId, String fromNickName){
        return new SendMessageAO(SenderSystemType.FAN.getValue(), 0L, targetId, MessageType.FOLLOW.name(), fromNickName + " 关注了你",
                JsonUtil.toJSONString(Map.of("data", "romNickName + \" 关注了你\"")), MessageClassEnum.IM.getValue(), false );
    }

    public static SendMessageAO buildProductStarInteractMsg(Long targetId, ProductStarInteractMsgBody productStarInteractMsgBody){
        ...
        return new SendMessageAO(SenderSystemType.INACTIVE.getValue(), 0L, targetId, MessageType.STAR_PRODUCT.name(), productStarInteractMsgBody.getAlertMsg(),
                JsonUtil.toJSONString(productStarInteractMsgBody), MessageClassEnum.IM.getValue(), false );
    }

    public static SendMessageAO buildProductCommentStarInteractMsg(Long targetId, ProductCommentStarInteractMsgBody videoCommentStarInteractMsgBody){
        ...
        return new SendMessageAO(SenderSystemType.INACTIVE.getValue(), 0L, targetId, MessageType.STAR_PRODUCT_COMMENT.name(), videoCommentStarInteractMsgBody.getAlertMsg(),
                JsonUtil.toJSONString(videoCommentStarInteractMsgBody), MessageClassEnum.IM.getValue(), false );
    }

    public static SendMessageAO buildProductCommentInteractMsg(Long targetId, ProductCommentInteractMsgBody productCommentStarInteractMsgBody){
        ...
        return new SendMessageAO(SenderSystemType.INACTIVE.getValue(), 0L, targetId, MessageType.COMMENT_PRODUCT.name(), productCommentStarInteractMsgBody.getAlertMsg(),
