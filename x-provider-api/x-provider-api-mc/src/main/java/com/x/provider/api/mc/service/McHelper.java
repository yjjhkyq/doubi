...
public class McHelper {
    ...
    public static SendMessageAO buildVideoStarInteractMsg(Long targetId, VideoStarInteractMsgBody videoStarInteractMsgBody){
        ...
        return new SendMessageAO(SenderSystemType.INACTIVE.getValue(), 0L, targetId, MessageType.STAR_PRODUCT.name(), videoStarInteractMsgBody.getAlertMsg(),
                JsonUtil.toJSONString(videoStarInteractMsgBody), MessageClassEnum.IM.getValue(), false );
    }
    ...
    public static SendMessageAO buildVideoCommentInteractMsg(Long targetId, VideoCommentInteractMsgBody videoCommentStarInteractMsgBody){
        ...
        return new SendMessageAO(SenderSystemType.INACTIVE.getValue(), 0L, targetId, MessageType.COMMENT_PRODUCT.name(), videoCommentStarInteractMsgBody.getAlertMsg(),
                JsonUtil.toJSONString(videoCommentStarInteractMsgBody), MessageClassEnum.IM.getValue(), false );
    }
}
